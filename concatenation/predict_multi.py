...
networks = { 'resnet50': ['crop_resnet50' + x + '.h5' for x in ['2019-11-03 21:34:21']], # verified timestamp 1/7
            'densenet':['crop_densenet' + x + '.h5' for x in ['2019-11-19 09:45:25']],# verified timestamp 1/7
            'vgg16':['crop_vgg16' + x + '.h5' for x in ['2020-02-11 06:49:02']] # updated after adding dropout
}
