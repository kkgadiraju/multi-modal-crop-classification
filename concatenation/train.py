...
dropout_rate = float(config[parser_args.task]['DROPOUT'])
...
# add an LSTM layer
lstm_1 = LSTM(128, input_shape=(23,1), return_sequences=True)(temporal_input_layer)

lstm_2 = LSTM(64)(lstm_1)
#x = LSTM(32)(x)

# add a dense layer
ts_output = Dense(32, activation="relu")(lstm_2)
...
# and a softmax layer -- 4 classes
predictions = Dense(4, activation='softmax')(final_dense)
...
history = model.fit_generator(train_generator,  
			epochs=num_epochs,
			steps_per_epoch=26948//batch_size,
			validation_data= val_generator, 
			validation_steps=8980//batch_size,
			verbose=1, 
